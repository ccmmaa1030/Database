...
print('id :', director_.id)
print('name :', director_.name)
print('debut :', director_.debut)
print('country :', director_.country)
```
...
```python
m = Movie.objects.all().order_by('opening_date')[0]
print(m.director.name, m.genre.title, m.title, m.opening_date, m.running_time, m.screening)
```
...
movies = Movie.objects.filter(director_id=bong.id).order_by('opening_date')
for m in movies:
    print(m.director.name, m.genre.title, m.title, m.opening_date, m.running_time, m.screening)
```
...
```python
bong = Director.objects.get(name='봉준호')
m = Movie.objects.filter(director_id=bong.id).order_by('opening_date')[1]
print(m.director.name, m.genre.title, m.title, m.opening_date, m.running_time, m.screening)
```
...
movies = Movie.objects.filter(director_id=bong.id, genre_id=drama.id).order_by('opening_date')
for m in movies:
    print(m.director.name, m.genre.title, m.title, m.opening_date, m.running_time, m.screening)
```
...
```python
bong = Director.objects.get(name='봉준호')
movies = Movie.objects.exclude(director_id=bong.id).order_by('opening_date')
for m in movies:
    print(m.director.name, m.genre.title, m.title, m.opening_date, m.running_time, m.screening)
```